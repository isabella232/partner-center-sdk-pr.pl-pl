...
| DefaultInteractiveAuthenticationMethod | ciąg           | Nie      | Wskazuje domyślną metodę uwierzytelniania, która ma być używana, gdy aplikacja wymaga logowania interakcyjnego przez użytkownika. |
...
| OpenIdConnectDiscoveryEndpoint         | ciąg           | Nie      | Punkt końcowy odnajdywania Połączenie OpenID federeracyjną usługą STS dostawcy tożsamości. |
