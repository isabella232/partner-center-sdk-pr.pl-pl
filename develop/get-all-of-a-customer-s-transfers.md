...
description: Jak uzyskać listę przeniesień klienta.
ms.date: 04/10/2020
...
ms.locfileid: "115996125"
---
# <a name="get-a-customers-transfers"></a>Pobieranie transferów klienta

Jak uzyskać listę przeniesień klienta.
...
|---------|------------------------------------------------------------------------------------------------------|
| **Pobierz** | [*{baseURL}*](partner-center-rest-urls.md)/v1/customers/{customer-tenant-id}/transfers HTTP/1.1 |
...
W przypadku powodzenia ta metoda zwraca listę zasobów [TransferEntity](transfer-entity-resources.md) w treści odpowiedzi.
