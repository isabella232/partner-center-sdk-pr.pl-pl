...
Jak uzyskać listę transferów klientów.
...
Jeśli to się powiedzie, metoda zwraca listę zasobów [TransferEntity](transfer-entity-resources.md) w treści odpowiedzi.
