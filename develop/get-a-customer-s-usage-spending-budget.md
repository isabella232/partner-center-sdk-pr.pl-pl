...
Budżet wydatków (obiekt **SpendingBudget)** można zaktualizować w podsumowaniu użycia klienta [ **(zasobie CustomerUsageSummary).**](customer-usage-resources.md#customerusagesummary)
