...
- [Żądanie relacji odsprzedawcy](request-reseller-relationship.md)
- [Usuwanie relacji odsprzedaży z klientem](remove-a-reseller-relationship-with-a-customer.md)

## <a name="look-up-a-customer"></a>Look up a customer (Wyszukiwania klienta)

- [Pobieranie klienta według identyfikatora](get-a-customer-by-id.md)
- [Uzyskiwanie klienta według nazwy firmy lub domeny](get-a-customer-by-name.md)
...
- [Uzyskiwanie wszystkich subskrypcji klienta](get-all-of-a-customer-s-subscriptions.md)
...
- [Aktualizowanie budżetu wydatków na użycie przez klienta](update-a-customer-s-usage-spending-budget.md)
...
- [Uzyskiwanie potwierdzenia akceptacji umowy chmury firmy Microsoft przez klienta](get-confirmation-of-customer-consent.md)
...
- [Sprawdzanie, które licencje są przypisane do użytkownika](check-which-licenses-are-assigned-to-a-user.md)
