---
title: Pobiera listę marginesów dla danego partnera.
description: Pobiera listę marginesów dla danego partnera.
ms.date: 09/30/2021
...
ms.locfileid: "129646397"
---
# <a name="get-margins"></a>Uzyskiwanie marginesów

**Dotyczy:** Partner Center 

**Odpowiednie role:** Administrator globalny | Agent administracyjny

Partnerzy mogą uzyskać listę aktywnych marginesów dla danego partnera. Ta metoda zwraca marginesy na podstawie partnera oraz dostępnych dat rozpoczęcia i zakończenia. 
...
|----------|-------------------------------------------------------------------------------------------------------------------------------------|
| **POBIERZ**  | [*{baseURL}*](partner-center-rest-urls.md)/v1/margins HTTP/1.1 |
...
W przypadku powodzenia ta metoda zwraca listę marginesów.
