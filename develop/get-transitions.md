...
Służy do uzyskania historii przejść dla danego klienta i subskrypcji. Historia obejmuje wszystkie zdarzenia, które zostały przetworzone w celu przejścia. Obsługuje to tylko nowe przejścia subskrypcji oparte na licencjach handlowych.
...
|----------|-------------------------------------------------------------------------------------------------------------------------------------|
| **POBIERZ**  | [*{baseURL}*](partner-center-rest-urls.md)/v1/customers/{identyfikator-dzierżawy-klienta}/subscriptions/{identyfikator-subskrypcji}/transitions HTTP/1.1 |
...
| **identyfikator-dolny** | **guid** | Y        | Identyfikator GUID odpowiadający początkowej subskrypcji. |
...
Jeśli to się powiedzie, ta historia metod przejść.
