...
W tej sekcji opisano, jak Dostawca rozwiązań w chmurze mogą używać Partner Center do programowego zarządzania zamówieniami i subskrypcjami klientów.
...
## <a name="get-offers-from-the-catalog"></a>Uzyskiwanie ofert z katalogu

- [Uzyskiwanie listy kategorii ofert według kraju i lokalizacji regionalnych](get-a-list-of-offer-categories-by-country-and-locale.md)
...
## <a name="manage-an-order"></a>Zarządzanie zamówieniem
...
## <a name="enable-a-subscription-for-azure-reserved-vm-instance-purchases"></a>Włączanie subskrypcji dla zakupów wystąpień zarezerwowanych maszyn wirtualnych platformy Azure
...
## <a name="get-subscription-details"></a>Uzyskiwanie szczegółów subskrypcji
